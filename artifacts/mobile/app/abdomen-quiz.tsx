...
import { ABDOMEN_QUESTIONS } from "@/constants/abdomenQuiz";
import { ABDOMEN_IMAGES } from "@/constants/abdomenImages";

const TOTAL = ABDOMEN_QUESTIONS.length;
...
export default function AbdomenQuizScreen() {
  ...
  const question = ABDOMEN_QUESTIONS[index];
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <Image
            source={ABDOMEN_IMAGES[question.id] as any}
