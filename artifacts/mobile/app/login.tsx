...
function InputField({
  ...
  return (
    ...
    >
      <Feather name={icon} size={18} color={focused ? "#7C3AED" : "#9090B0"} style={styles.inputIcon} />
      <TextInput
        style={styles.input}
      ...
      {isPassword && (
        <Pressable onPress={() => setShowPw((v) => !v)} style={styles.eyeBtn}>
          <Feather name={showPw ? "eye-off" : "eye"} size={16} color="#9090B0" />
        </Pressable>
      )}
    </View>
  );
        ...
        >
          <View style={styles.hero}>
            ...
            <Text style={styles.appName}>
              ...
              <Text style={styles.appNamePurple}>Spotter</Text>
            </Text>
...
const styles = StyleSheet.create({
  ...
  appNameLight: { color: "#F8F8FF", fontFamily: "Inter_700Bold" },
  appNamePurple: { color: "#7C3AED", fontFamily: "Inter_700Bold" },
  appTagline: {
    color: "#9090B0",
  ...
  inputWrapFocused: { borderColor: "#7C3AED" },
