...
import { THORAX_QUESTIONS } from "@/constants/thoraxQuiz";
import { THORAX_IMAGES } from "@/constants/thoraxImages";

const TOTAL = THORAX_QUESTIONS.length;
...
export default function ThoraxQuizScreen() {
  ...
  const question = THORAX_QUESTIONS[index];
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <Image
            source={THORAX_IMAGES[question.id]}
